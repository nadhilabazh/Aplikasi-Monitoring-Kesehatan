            ...
            <div class="col-lg-12">
                ...
                if (isset($_POST['simpan'])) {
                    if (empty($nip)) {
                        ...
                        $save = mysqli_query($conect, "INSERT INTO pegawai (nip, nama, alamat, tgl_lahir, jk, no_hp, email, id_divisi) VALUE ('$nip','$nama','$alamat','$tgl_lahir','$jk','$no_hp','$email','$id_divisi')");
                        if ($save) {
                            echo "<script>alert('Data Pegawai Berhasil Ditambahkan');document.location='data_pegawai.php'</script>";
                        } else {
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="data_pegawai.php" title="Kembali"><button name="input"
                            ...
                            <form action="" method="post" enctype="multipart/form-data" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama"
                                        name="nama" value="<?php echo $_POST['nama']; ?>"
                                        maxlength="100">
                                </div>
                                <?php echo $er_nama; ?>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Jenis Kelamin"
                                        name="jk" value="<?php echo $_POST['jk']; ?>"
                                        maxlength="100">
                                </div>
                                <?php echo $er_jk; ?>
                                <div class="form-group">
