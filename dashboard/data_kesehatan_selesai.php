                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <form action="cari_data_kesehatan_selesai.php" method="get" class="form-inline text-right">
                            <input type="text" class="form-control" name="id_kesehatan"
                                placeholder="Masukkan Id Kesehatan" required>
                            <button type="submit" class="btn btn-success">Cari</button>
                            <a href="cetak_data_kesehatan_disetujui.php" class="btn btn-success">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Deskripsi</th>
                                        <th>Tanggal Kesehatan Disetujui</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from kesehatan_selesai, divisi, pegawai where kesehatan_selesai.id_divisi = divisi.id_divisi and kesehatan_selesai.nip = pegawai.nip order by tgl_disetujui desc limit $posisi, $batas");
                 ...
                 <a href="../dashboardpegawai/file/<?php echo $a['lampiran_suket'];?>" target="_BLANK"><button class="btn btn-success btn-sm"><i
                         class="fa fa-file-o fa-fw"></i> <?php echo $a['lampiran_suket'];?></button></a></td>
                                        ...
                                        <td><?php echo $a['tgl_disetujui']; ?></td>
                                        <td>
                        ...
                        <div class="text-center">
                            ...
                            $jml_data = mysqli_num_rows(mysqli_query($conect, "select*from kesehatan_selesai, divisi, pegawai where kesehatan_selesai.id_divisi = divisi.id_divisi and kesehatan_selesai.nip = pegawai.nip order by tgl_disetujui desc"));
