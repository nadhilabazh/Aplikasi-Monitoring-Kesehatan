                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    $db = mysqli_connect($databaseHost, $databaseUsername, $databasePassword, $databaseName);
                                    $sql = "select*from kesehatan, pegawai, divisi where (kesehatan.nip = pegawai.nip and kesehatan.id_divisi = divisi.id_divisi) and pegawai.id = '$_SESSION[id]' order by tgl_periksa desc limit 5";
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    $db = mysqli_connect($databaseHost, $databaseUsername, $databasePassword, $databaseName);
                                    $sql = "select*from kesehatan_selesai, pegawai, divisi where (kesehatan_selesai.nip = pegawai.nip and kesehatan_selesai.id_divisi = divisi.id_divisi) and pegawai.id='$_SESSION[id]' order by tgl_disetujui desc limit 5";
                                    $query = mysqli_query($db, $sql);
                                    $jumlah3 = mysqli_num_rows($query);
                                    if ($jumlah3 == 0) {
                                    ?>
