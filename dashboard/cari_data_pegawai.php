                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from pegawai, divisi where pegawai.id_divisi = divisi.id_divisi and nip LIKE '%$_GET[nip]%' order by nip desc limit $posisi, $batas");
                        ...
                        <div class="text-center">
                            ...
                            $jml_data = mysqli_num_rows(mysqli_query($conect, "select*from pegawai, divisi where pegawai.id_divisi = divisi.id_divisi and nip LIKE '%$_GET[nip]%' order by nip desc"));
