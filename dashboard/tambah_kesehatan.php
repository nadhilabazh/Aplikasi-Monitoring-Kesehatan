            ...
            <div class="col-lg-12">
                ...
                if (isset($_POST['simpan'])) {
                    if (empty($id_kesehatan)) {
                        ...
                        $save = mysqli_query($conect, "INSERT INTO kesehatan (id_kesehatan, nip, id_divisi, lampiran_suket, status_kesehatan, deskripsi, tgl_periksa, status) VALUE ('$id_kesehatan', '$nip', '$id_divisi', '$lampiran_suket', '$status_kesehatan', '$deskripsi', '$tgl_periksa', 'belum disetujui')");
                        if ($save) {
                            ...
                            <form action="" method="post" enctype="multipart/form-data" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nama" class="form-control">
                                        ...
                                        while ($d = mysqli_fetch_array($pegawai)) {
                                            if ($d['nip'] == $_POST['nama']) {
                                                echo "
                                        <option value='$d[nip]' selected>$d[nama]</option>";
                                            } else {
                                                echo "
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nama_divisi" class="form-control">
                                        ...
                                        <?php $nama_divisi = mysqli_query($conect, "select *from divisi");
                                        while ($c = mysqli_fetch_array($nama_divisi)) {
