            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="panel-heading">
                            <div class="col-lg-6">
                                <a href="tambah_divisi.php" title="Tambah Divisi"><button name="input"
                                class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>  Tambah Divisi
                                    </button></a>
                            </div>
                            <div class="col-lg-6">
                                <form action="cari_data_divisi.php" method="get" class="form-inline text-right">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $ambildata = mysqli_query($conect, "select*from divisi order by id_divisi desc limit $posisi, $batas");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_data_divisi.php?id=<?php echo $a['id_divisi']; ?>"
                                                    title="Edit data"><button class="btn btn-primary btn-sm"><i
                                                            class="fa fa-pencil-square-o fa-fw"></i> Edit</button>
                                                </a>
                                                <a href="hapus_data_divisi.php?id=<?php echo $a['id_divisi']; ?>"
                            ...
                            <div class="text-center">
                                ...
                                $jml_data = mysqli_num_rows(mysqli_query($conect, "select*from divisi order by id_divisi desc"));
