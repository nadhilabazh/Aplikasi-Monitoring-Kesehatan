                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from kesehatan, pegawai, divisi where kesehatan.nip = pegawai.nip and kesehatan.id_divisi = divisi.id_divisi and id_kesehatan LIKE '%$_GET[id_kesehatan]%' order by tgl_periksa desc limit $posisi, $batas");
                        ...
                        <div class="text-center">
                            ...
                            $jml_data = mysqli_num_rows(mysqli_query($conect, "select*from kesehatan, pegawai, divisi where kesehatan.nip = pegawai.nip and kesehatan.id_divisi = divisi.id_divisi and id_kesehatan LIKE '%$_GET[id_kesehatan]%' order by tgl_periksa desc"));
