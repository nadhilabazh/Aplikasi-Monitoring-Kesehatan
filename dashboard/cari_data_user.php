                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <form action="cari_data_user.php" method="get" class="form-inline text-right">
                            <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama"
                                value="<?php echo $_GET['nama']; ?>" required>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from user where nama LIKE '%$_GET[nama]%' order by id desc limit $posisi, $batas");
                        ...
                        <div class="text-center">
                            ...
                            $jml_data = mysqli_num_rows(mysqli_query($conect, "select*from user where nama LIKE '%$_GET[nama]%' order by id desc"));
