                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <form action="cari_data_divisi.php" method="get" class="form-inline text-right">
                            <input type="text" class="form-control" name="nama_divisi"
                                placeholder="Masukkan Nama Divisi" value="<?php echo $_GET['nama_divisi']; ?>"
                                required>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from divisi where nama_divisi LIKE '%$_GET[nama_divisi]%' order by id_divisi desc limit $posisi, $batas");
                        ...
                        <div class="text-center">
                            ...
                            $jml_data = mysqli_num_rows(mysqli_query($conect, "select*from divisi where nama_divisi LIKE '%$_GET[nama_divisi]%' order by id_divisi  desc"));
