            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="col-lg-6">
                            <a href="tambah_kesehatan.php" title="Tambah Data Kesehatan"><button name="input"
                            class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Tambah Data Kesehatan
                                </button></a>
                        </div>
                        <div class="col-lg-6">
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from kesehatan, pegawai, divisi where (kesehatan.nip = pegawai.nip and kesehatan.id_divisi = divisi.id_divisi) and pegawai.id='$_SESSION[id]' order by tgl_periksa desc limit $posisi, $batas");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_data_kesehatan.php?id=<?php echo $a['id_kesehatan']; ?>"
