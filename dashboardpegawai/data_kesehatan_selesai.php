                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $ambildata = mysqli_query($conect, "select*from kesehatan_selesai, divisi, pegawai where (kesehatan_selesai.id_divisi = divisi.id_divisi and kesehatan_selesai.nip = pegawai.nip) and pegawai.id='$_SESSION[id]' order by tgl_disetujui desc limit $posisi, $batas");
